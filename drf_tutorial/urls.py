...
# schema_view = get_schema_view(title="DRF Tutorial API", description="API for DRF Tutorial")
...
urlpatterns = [
    ...
    path('docs/', include_docs_urls(title="DRF Tutorial API", description="API for DRF Tutorial")),
